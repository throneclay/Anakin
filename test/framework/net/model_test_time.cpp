...
TEST(NetTest, nv_net_execute_base_test) {
    ...
    for (auto iter = models.begin(); iter < models.end(); iter++) {
        ...
        file << "op_type,filter_Num,kernel_h,kernel_w,pad_h,pad_w,stride_h,stride_w,dilation_h,dilation_w,group,input_N,input_C,intput_H,input_W,time" << std::endl;
